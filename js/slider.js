! function(e, t) {
    ...
    function l(e, t, n) {
        ...
        if (void 0 === n && 1 === e.nodeType)
            if (i = "data-" + t.replace(_e, "-$&").toLowerCase(), n = e.getAttribute(i), "string" == typeof n) {
                try {
    ...
    function k(e, t, n, i) {
        ...
        var o, r, s, a, l, c, d = 0,
            ...
            g = t[0],
            v = re.isFunction(g);
        if (v || f > 1 && "string" == typeof g && !ie.checkClone && Re.test(g)) return e.each(function(o) {
            var r = e.eq(o);
            v && (t[0] = g.call(this, o, r.html())), k(r, t, n, i)
        });
        if (f && (o = p(t, e[0].ownerDocument, !1, e, i), r = o.firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
            for (s = re.map(u(o, "script"), m), a = s.length; f > d; d++) l = o, d !== h && (l = re.clone(l, !0, !0), a && re.merge(s, u(l, "script"))), n.call(e[d], l, d);
            if (a)
    ...
    function $(e, t, n) {
        ...
        return n = n || Qe(e), s = n ? n.getPropertyValue(t) || n[t] : void 0, "" !== s && void 0 !== s || re.contains(e.ownerDocument, e) || (s = re.style(e, t)), n && !ie.pixelMarginRight() && Ve.test(s) && Ge.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r), void 0 !== s ? s + "" : s
    }
    ...
    function E(t, n, i) {
        ...
        if (V.msFullscreenElement && e.top !== e && t.getClientRects().length && (r = Math.round(100 * t.getBoundingClientRect()[n])), 0 >= r || null == r) {
            if (r = $(t, n, s), (0 > r || null == r) && (r = t.style[n]), Ve.test(r)) return r;
    ...
    var ue = function(e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : F) !== O && E(t), t = t || O, N)) {
                if (11 !== g && (c = ye.exec(e)))
                    if (o = c[1]) {
                        if (9 === g) {
                ...
                if (x.qsa && !U[e + " "] && (!P || !P.test(e))) {
                    if (1 !== g) h = t, f = e;
                        ...
                        f = d.join(","), h = me.test(e) && u(t.parentNode) || t
                    }
                    if (f) try {
        ...
        function f(e, t, n) {
            ...
            return t.first ? function(t, n, r) {
                ...
                if (s) {
                    ...
                    for (; t = t[i];)
                        if (1 === t.nodeType || o) {
                            if (c = t[q] || (t[q] = {}), l = c[t.uniqueID] || (c[t.uniqueID] = {}), (a = l[i]) && a[0] === z && a[1] === r) return u[2] = a[2];
        ...
        function y(e, t, n, o, r, s) {
            return o && !o[q] && (o = y(o)), r && !r[q] && (r = y(r, s)), i(function(i, s, a, l) {
                var c, u, d, p = [],
                    ...
                    b = n ? r || (i ? e : h || o) ? [] : s : m;
                if (n && n(m, b, a, l), o)
                    for (c = v(b, f), o(c, [], a, l), u = c.length; u--;)(d = c[u]) && (b[f[u]] = !(m[f[u]] = d));
                if (i) {
                    if (r || e) {
                        if (r) {
                ...
                if (n = k.relative[e[a].type]) u = [f(h(u), n)];
                    ...
                    if (n = k.filter[e[a].type].apply(null, e[a].matches), n[q]) {
                        ...
                        return y(a > 1 && h(u), a > 1 && p(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(ae, "$1"), n, i > a && m(e.slice(a, i)), o > i && m(e = e.slice(i)), o > i && p(e))
                    }
                    u.push(n)
                }
            return h(u)
            ...
            var o = n.length > 0,
                ...
                s = function(i, s, a, l, c) {
                    var u, d, p, f = 0,
                        ...
                        m = _,
                        b = i || r && k.find.TAG("*", c),
                        w = z += null == m ? 1 : Math.random() || .1,
                        x = b.length;
                    for (c && (_ = s === O || s || c); h !== x && null != (u = b[h]); h++) {
                        if (r && u) {
                            for (d = 0, s || u.ownerDocument === O || (E(u), a = !N); p = e[d++];)
                                if (p(u, s || O, a)) {
                                    l.push(u);
                                    break
                                }
        ...
        var w, x, k, T, S, C, $, A, _, j, D, E, O, I, N, P, H, L, M, q = "sizzle" + 1 * new Date,
            F = e.document,
            z = 0,
            W = 0,
            R = n(),
        ...
        try {
            J.apply(V = Z.call(F.childNodes), F.childNodes), V[F.childNodes.length].nodeType
        } catch (Te) {
            J = {
        ...
        x = t.support = {}, S = t.isXML = function(e) {
            ...
            return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, I = O.documentElement, N = !S(O), (n = O.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", ke, !1) : n.attachEvent && n.attachEvent("onunload", ke)), x.attributes = o(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), x.getElementsByTagName = o(function(e) {
                return e.appendChild(O.createComment("")), !e.getElementsByTagName("*").length
            }), x.getElementsByClassName = ve.test(O.getElementsByClassName), x.getById = o(function(e) {
                return I.appendChild(e).id = q, !O.getElementsByName || !O.getElementsByName(q).length
            ...
            }), P = P.length && new RegExp(P.join("|")), H = H.length && new RegExp(H.join("|")), t = ve.test(I.compareDocumentPosition), M = t || ve.test(I.contains) ? function(e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === O || e.ownerDocument === F && M(F, e) ? -1 : t === O || t.ownerDocument === F && M(F, t) ? 1 : j ? ee(j, e) - ee(j, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return D = !0, 0;
                var n, i = 0,
                    o = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== O && E(e), n = n.replace(ue, "='$1']"), x.matchesSelector && N && !U[n + " "] && (!H || !H.test(n)) && (!P || !P.test(n))) try {
                var i = L.call(e, n);
                if (i || x.disconnectedMatch || e.document && 11 !== e.document.nodeType) return i
            } catch (o) {}
            return t(n, O, null, [e]).length > 0
        }, t.contains = function(e, t) {
            return (e.ownerDocument || e) !== O && E(e), M(e, t)
        }, t.attr = function(e, t) {
            (e.ownerDocument || e) !== O && E(e);
            var n = k.attrHandle[t.toLowerCase()],
                i = n && G.call(k.attrHandle, t.toLowerCase()) ? n(e, t, !N) : void 0;
                    ...
                    return 1 === i && 0 === o ? function(e) {
                        ...
                        if (v) {
                            ...
                            if (h = [s ? v.firstChild : v.lastChild], s && m) {
                                for (p = v, d = p[q] || (p[q] = {}), u = d[p.uniqueID] || (d[p.uniqueID] = {}), c = u[e] || [], f = c[0] === z && c[1], b = f && c[2], p = f && v.childNodes[f]; p = ++f && p && p[g] || (b = f = 0) || h.pop();)
                                    if (1 === p.nodeType && ++b && p === t) {
                                        u[e] = [z, f, b];
                                        break
                                    }
                            } else if (m && (p = t, d = p[q] || (p[q] = {}), u = d[p.uniqueID] || (d[p.uniqueID] = {}), c = u[e] || [], f = c[0] === z && c[1], b = f), b === !1)
                                for (;
                                    (p = ++f && p && p[g] || (b = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++b || (m && (d = p[q] || (p[q] = {}), u = d[p.uniqueID] || (d[p.uniqueID] = {}), u[e] = [z, b]), p !== t)););
        ...
        return d.prototype = k.filters = k.pseudos, k.setFilters = new d, C = t.tokenize = function(e, n) {
            ...
            if (n = n || [], 1 === d.length) {
                ...
                for (o = fe.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !k.relative[a = s.type]);)
                    if ((l = k.find[a]) && (i = l(s.matches[0].replace(we, xe), me.test(r[0].type) && u(t.parentNode) || t))) {
                        if (r.splice(o, 1), e = i.length && p(r), !e) return J.apply(n, i), n;
                        break
                    }
            }
            return (c || $(e, d))(i, t, !N, n, !t || me.test(e) && u(t.parentNode) || t), n
        }, x.sortStable = q.split("").sort(X).join("") === q, x.detectDuplicates = !!D, E(), x.sortDetached = o(function(e) {
    ...
    re.fn.ready = function(e) {
        ...
        ready: function(e) {
            (e === !0 ? --re.readyWait : re.isReady) || (re.isReady = !0, e !== !0 && --re.readyWait > 0 || (ke.resolveWith(V, [re]), re.fn.triggerHandler && (re(V).triggerHandler("ready"), re(V).off("ready"))))
        }
    }), re.ready.promise = function(t) {
        return ke || (ke = re.Deferred(), "complete" === V.readyState || "loading" !== V.readyState && !V.documentElement.doScroll ? e.setTimeout(re.ready) : (V.addEventListener("DOMContentLoaded", s), e.addEventListener("load", s))), ke.promise(t)
    }, re.ready.promise();
    ...
    re.extend({
        ...
        data: function(e, t) {
            ...
            return "object" == typeof e ? this.each(function() {
                ...
                var n, i;
                if (r && void 0 === t) {
                    if (n = $e.get(r, e) || $e.get(r, e.replace(_e, "-$&").toLowerCase()), void 0 !== n) return n;
    ...
    re.extend({
        ...
        html: function(e) {
            return Te(this, function(e) {
                ...
                if ("string" == typeof e && !We.test(e) && !He[(Ne.exec(e) || ["", ""])[1].toLowerCase()]) {
    ...
    re.extend({
        ...
        css: function(e, t, n, i) {
            var o, r, s, a = re.camelCase(t);
            return t = re.cssProps[a] || (re.cssProps[a] = _(a) || a), s = re.cssHooks[t] || re.cssHooks[a], s && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = $(e, t, i)), "normal" === o && t in tt && (o = tt[t]), "" === n || n ? (r = parseFloat(o), n === !0 || isFinite(r) ? r || 0 : o) : o
        }
        ...
        re.cssHooks[t] = {
            ...
            set: function(e, n, i) {
                var o, r = i && Qe(e),
                    s = i && D(e, t, i, "border-box" === re.css(e, "boxSizing", !1, r), r);
                return s && (o = De.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = re.css(e, t)), j(e, n, s)
            }
        }
        ...
        }, Ge.test(e) || (re.cssHooks[e + t].set = j)
    }), re.fn.extend({
        css: function(e, t) {
    ...
    re.extend(re.event, {
        trigger: function(t, n, i, o) {
            var r, s, a, l, c, u, d, p = [i || V],
                f = ne.call(t, "type") ? t.type : t,
                h = ne.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = a = i = i || V, 3 !== i.nodeType && 8 !== i.nodeType && !gt.test(f + re.event.triggered) && (f.indexOf(".") > -1 && (h = f.split("."), f = h.shift(), h.sort()), c = f.indexOf(":") < 0 && "on" + f, t = t[re.expando] ? t : new re.Event(f, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : re.makeArray(n, [t]), d = re.event.special[f] || {}, o || !d.trigger || d.trigger.apply(i, n) !== !1)) {
    ...
    _t.href = vt.href, re.extend({
        ...
        ajax: function(t, n) {
            function i(t, n, i, a) {
                var c, d, m, b, x, T = n;
                2 !== w && (w = 2, l && e.clearTimeout(l), o = void 0, s = a || "", k.readyState = t > 0 ? 4 : 0, c = t >= 200 && 300 > t || 304 === t, i && (b = B(p, k, i)), b = U(p, b, k, c), c ? (p.ifModified && (x = k.getResponseHeader("Last-Modified"), x && (re.lastModified[r] = x), x = k.getResponseHeader("etag"), x && (re.etag[r] = x)), 204 === t || "HEAD" === p.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = b.state, d = b.data, m = b.error, c = !m)) : (m = T, !t && T || (T = "error", 0 > t && (t = 0))), k.status = t, k.statusText = (n || T) + "", c ? g.resolveWith(f, [d, T, k]) : g.rejectWith(f, [k, T, m]), k.statusCode(y), y = void 0, u && h.trigger(c ? "ajaxSuccess" : "ajaxError", [k, p, c ? d : m]), v.fireWith(f, [k, T]), u && (h.trigger("ajaxComplete", [k, p]), --re.active || re.event.trigger("ajaxStop")))
            }
            ...
            var o, r, s, a, l, c, u, d, p = re.ajaxSetup({}, n),
                ...
                k = {
                    ...
                    setRequestHeader: function(e, t) {
                        var n = e.toLowerCase();
                        return w || (e = b[n] = b[n] || e, m[e] = t), this
                    },
            ...
            if (p.data && p.processData && "string" != typeof p.data && (p.data = re.param(p.data, p.traditional)), W(Ct, p, n, k), 2 === w) return k;
            u = re.event && p.global, u && 0 === re.active++ && re.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Tt.test(p.type), r = p.url, p.hasContent || (p.data && (r = p.url += (mt.test(r) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = wt.test(r) ? r.replace(wt, "$1_=" + yt++) : r + (mt.test(r) ? "&" : "?") + "_=" + yt++)), p.ifModified && (re.lastModified[r] && k.setRequestHeader("If-Modified-Since", re.lastModified[r]), re.etag[r] && k.setRequestHeader("If-None-Match", re.etag[r])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && k.setRequestHeader("Content-Type", p.contentType), k.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + At + "; q=0.01" : "") : p.accepts["*"]);
    ...
    re.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !re(this).is(":disabled") && It.test(this.nodeName) && !Ot.test(e) && (this.checked || !Ie.test(e))
            }).map(function(e, t) {
                var n = re(this).val();
    ...
    re.ajaxSetup({
        ...
        return a || "jsonp" === t.dataTypes[0] ? (o = t.jsonpCallback = re.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Lt, "$1" + o) : t.jsonp !== !1 && (t.url += (mt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function() {
    ...
    re.fn.load = function(e, t, n) {
        ...
        re.cssHooks[t] = A(ie.pixelPosition, function(e, n) {
            return n ? (n = $(e, t), Ve.test(n) ? re(e).position()[t] + "px" : n) : void 0
        })
    }), re.each({
        Height: "height",
        Width: "width"
...
function() {
    ...
    function N(e, t, n, i, o, r, s) {
        this.v = e, this.B = t, this.c = n, this.a = i, this.s = s || "BESbswy", this.f = {}, this.w = o || 3e3, this.u = r || null, this.o = this.j = this.h = this.g = null, this.g = new D(this.c, this.s), this.h = new D(this.c, this.s), this.j = new D(this.c, this.s), this.o = new D(this.c, this.s), e = new m(this.a.c + ",serif", x(this.a)), e = O(e), this.g.a.style.cssText = e, e = new m(this.a.c + ",sans-serif", x(this.a)), e = O(e), this.h.a.style.cssText = e, e = new m("serif", x(this.a)), e = O(e), this.j.a.style.cssText = e, e = new m("sans-serif", x(this.a)), e = O(e), this.o.a.style.cssText = e, E(this.g), E(this.h), E(this.j), E(this.o)
    }
            ...
            if (0 === i.length && s) $(t.a);
                ...
                for (c = 0; c < i.length; c++) {
                    var d = i[c],
                        ...
                        f = t.a,
                        h = d;
                    f.g && a(f.f, [f.a.c("wf", h.c, x(h).toString(), "loading")]), A(f, "fontloading", h), f = null, null === se && (se = !!window.FontFace && (!(h = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent)) || 42 < parseInt(h[1], 10))), f = se ? new I(n(t.g, t), n(t.h, t), t.c, d, t.s, p) : new N(n(t.g, t), n(t.h, t), t.c, d, t.s, e, p), u.push(f)
                }
    ...
    function J(e) {
        for (var t = e.f.length, n = 0; n < t; n++) {
            ...
            for (e.c[o] || (i = le[o]) && (e.c[o] = i), i = 0; i < r.length; i += 1) e.a.push(new m(o, r[i]))
        }
    }
    ...
    F.prototype.g = function(e) {
        var t = this.a;
        t.g && a(t.f, [t.a.c("wf", e.c, x(e).toString(), "active")], [t.a.c("wf", e.c, x(e).toString(), "loading"), t.a.c("wf", e.c, x(e).toString(), "inactive")]), A(t, "fontactive", e), this.o = !0, z(this)
            ...
            if (o["__mti_fntLst" + n]) {
                ...
                if (r)
                    for (var a = 0; a < r.length; a++) {
                        ...
                        void 0 != r[a].fontStyle && void 0 != r[a].fontWeight ? (i = r[a].fontStyle + r[a].fontWeight, s.push(new m(l, i))) : s.push(new m(l))
                    }
                e(s)
        ...
        for (t = 0, n = o.length; t < n; t++)
            if (i = o[t].split(":"), i[1])
                for (var l = i[1].split(","), c = 0; c < l.length; c += 1) a.push(new m(i[0], l[c]));
            else a.push(new m(i[0]));
        g(s, function() {
            e(a, r)
        })
    };
    ...
    Z.prototype.load = function(e) {
        ...
        t ? p(this.c, (this.a.api || "https://use.typekit.net") + "/" + t + ".js", function(t) {
            if (t) e([]);
                ...
                for (var i = [], o = 0; o < t.length; o += 2)
                    for (var r = t[o], s = t[o + 1], a = 0; a < s.length; a++) i.push(new m(r, s[a]));
                try {
                    n.Typekit.load({
                        events: !1,
                        classes: !1,
        ...
        t ? (n.__webfontfontdeckmodule__ || (n.__webfontfontdeckmodule__ = {}), n.__webfontfontdeckmodule__[t] = function(t, n) {
            for (var o = 0, r = n.fonts.length; o < r; ++o) {
                var s = n.fonts[o];
                i.a.push(new m(s.name, T("font-weight:" + s.weight + ";font-style:" + s.style)))
            }
            e(i.a)
            ...
            if ("horizontal" === e.options.layout)
                ...
                for (d = 1; d <= i.length; d++) {
                    ...
                    var v = i[d - 1].outerWidth(),
                        y = 0;
                    i[d] && (y = i[d].width()), f.push({
                        left: c,
                        top: u
                    }), p = c + a + y, p > g ? (p = 0, c = 0, u += i[0].outerHeight(), s++) : c += v
                }
                o = s * i[0].outerHeight()
                ...
                for (d = 0; d < r; d++) {
                    for (var m = 0, b = d; i[b];) m += i[b].outerHeight(), b += r;
                    m > o ? (o = m, m = 0) : m = 0
                }
...
function(e, t) {
    ...
    var e = function() {
        ...
        var t = ["Playfair+Display:400,400italic,700,700italic:latin", "Montserrat:700,400:latin"];
        return {
            load: e
        }
    }();
    ...
    var t = function() {
        ...
        n = function() {
            var e = function() {
                $(".js-show-more-works").on("click", function(e) {
                    e.preventDefault(), $(this).fadeOut(400, function() {
        ...
        i = function() {
            var e = function() {
                    var e = $(".js-filtering-button");
                    e.on("click", function(t) {
                        t.preventDefault(), e.removeClass("button--black").addClass("button--gray"), $(this).addClass("button--black")
                    })
                },
                t = function() {
                    e();
                    var t = {
                        ...
                        n = $(".filtr-container").filterizr(t);
                    n.filterizr("setOptions", t)
                };
            return {
                init: t
            }
            ...
            var e = $(".js-content-trigger"),
                ...
                i = function() {
                    e.on("click", function(i) {
                        i.preventDefault();
                        var o = $(this).attr("data-content-index");
                        e.removeClass("state-active"), $(this).addClass("state-active"), t.slideUp(n), setTimeout(function() {
                            $('.js-content-box[data-content-index="' + o + '"]').slideDown(n)
                        }, n / 2)
                    })
                };
            return {
        ...
        s = {
            ...
            bindOpeners: function() {
                $(".js-dropdown-opener").off().on("click", function(e) {
                    e.preventDefault(), e.stopPropagation();
                    var t = $(this).attr("data-dropdown-target"),
                        n = $("[data-dropdown-name=" + t + "]");
                    s.toggle(n)
                })
            },
            init: function() {
                this.bindCollapsingAll(), this.bindOpeners()
            }
        },
        a = {
            DOM: {
            ...
            bind: function() {
                function e(e) {
                    try {
                        var t = $(e).parents(".js-cover").offset().top;
                        $("html,body").animate({
                            scrollTop: t
                        }, 400)
                    } catch (n) {
                ...
                for (var t = this, n = document.querySelectorAll(".js-open-menu"), i = 0; i < n.length; i++) n[i].addEventListener("click", function(n) {
                    n.preventDefault(), e(this);
                    var i = $(this).attr("data-menu-index"),
                        o = $('.js-menu[data-menu-index="' + i + '"]');
                    $(t.DOM.overlay).addClass("state-visible"), $(t.DOM.body).addClass("state-fixed"), o.addClass("state-opened")
                });
                for (var o = document.querySelectorAll(".js-close-menu"), i = 0; i < o.length; i++) o[i].addEventListener("click", function(e) {
                    e.preventDefault(), $(t.DOM.overlay).removeClass("state-visible"), $(t.DOM.body).removeClass("state-fixed"), $(t.DOM.menu).removeClass("state-opened")
                })
            },
            init: function() {
                this.bind()
        ...
        l = {
            ...
            open: function(e) {
                $('[data-popup-name="' + e + '"]').fadeIn(this.OPENING_DURATION).addClass("state-visible"), this.toggleOverlay(), this.toggleBodyFix()
            },
            closeOpened: function() {
                var e = this;
                e.DOM.$popups.fadeOut(e.OPENING_DURATION), setTimeout(function() {
                    e.DOM.$popups.removeClass("state-visible")
                }, e.OPENING_DURATION), this.toggleOverlay(), this.toggleBodyFix()
            },
    ...
    c.DOM.$covers.length && (c.setIntroHeight(), c.init());
    var u = function() {
            function e() {
                n.$toggler.removeClass("state-opened"), n.$linksBox.slideUp(), $(n.overlay).removeClass("state-visible")
            }

            function t() {
                n.$toggler.toggleClass("state-opened"), n.$linksBox.slideToggle(), $(n.overlay).toggleClass("state-visible")
            }
            var n = {
                ...
                i = function() {
                    n.$toggler.on("click", function(e) {
                        e.preventDefault(), t()
                    }), $(".js-navigation-link").on("click", function(t) {
                        t.preventDefault(), e();
                    ...
                    }), $(".js-close-navigation").on("click", function(t) {
                        t.preventDefault(), e()
                    })
                };
            return {
        ...
        d = (function() {
            function e(e) {
                var t = e.find($(".js-submit-button")),
                    n = e.find($(".js-submit-button")).text();
                t.text(n + "..."), $.ajax({
                    url: "/send_mail.php",
                    type: "POST",
                    data: e.serialize()
                }).done(function(e) {
                    console.log(e), $(".js-popup__title--success").slideToggle(), $(".js-popup__title--initial").slideToggle(), setTimeout(function() {
                        $(".js-popup__title--success").slideToggle(), $(".js-popup__title--initial").slideToggle()
                    }, 8e3)
                }).fail(function(e) {
                    console.log("error"), alert("Internal error ;( Please, try sending a direct email: hello@ui-market.com")
                }).always(function(i) {
                    t.text(n), console.log(e.serialize())
                })
            }
            ...
            function t(e) {
                $.ajax({
                    type: e.attr("method"),
                    url: e.attr("additionalAction"),
                    data: e.serialize(),
                    cache: !1,
                    dataType: "json",
                    contentType: "application/json; charset=utf-8"
                }).done(function(t) {
                    "success" != t.result, e.find(".js-success-message").slideDown()
            ...
            return {
                bind: function() {
                    n.savingForm.on("submit", function(n) {
                        n.preventDefault(), e($(this)), t($(this))
                    })
                }
            }
        }(), function() {
            function e(e) {
                ...
                $.ajax({
                    ...
                    "success" != e.result ? (o.slideUp(r), i.slideUp(r), setTimeout(function() {
                        o.html(t(e.msg)), o.slideDown(r)
                    }, r)) : o.slideUp(r, function() {
                        i.slideDown(r)
                    })
                }).fail(function(e) {
                    o.slideUp(r), i.slideUp(r, function() {
                        o.slideDown(r, function() {
        ...
        f = function() {
            function e(e) {
                for (var n = e.length, i = 0; i < n; i++) {
                    var o = e[i],
                        r = parseFloat(o.getAttribute("data-zoom"), 10),
                        s = parseFloat(o.getAttribute("data-center-lat"), 10),
                        a = parseFloat(o.getAttribute("data-center-lng"), 10),
                        l = parseFloat(o.getAttribute("data-pin-lat"), 10),
                        c = parseFloat(o.getAttribute("data-pin-lng"), 10),
                        u = new google.maps.Map(o, {
                            center: {
                                lat: s,
                                lng: a
                            },
                        ...
                        d = "/img/inner_pages_icons/i--map-pin.png";
    ...
    l.init(), a.init(), s.init(), e.load(), o.bindScrollFullscreen(), r.bind(), t.init(), u.bind(), n.bind(), $(".filtr-container").length > 0 && i.init(), d.bind(), p.init(), f.init(document.querySelectorAll(".js-map"))
});